...
user in an INI file next to CaseiumPortable.exe called CaseiumPortable.ini.
...
copy AppNamePortable.ini from this directory to CaseiumPortable.ini next to
CaseiumPortable.exe. The options in the INI file are as follows:
